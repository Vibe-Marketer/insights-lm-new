...
const EmptyDashboard = () => {
  ...
  return <div className="text-center py-16">
      <div className="mb-12">
        ...
        <p className="text-lg text-gray-600 max-w-2xl mx-auto">TranscriptsOS is an AI-powered transcript management system that works best with the sources you upload</p>
      </div>
